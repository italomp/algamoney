...
public class FinancialPostingController {
    ...
    @GetMapping
    public ResponseEntity<List<FinancialPosting>> getAll(FinancialPostingFilter financialPostingFilter) {
        List<FinancialPosting> postingList = this.postingService.findAll(financialPostingFilter);
